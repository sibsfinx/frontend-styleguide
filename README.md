...
3.3. Классы именуем осмысленно, по схеме вида "блок__элемент__подэлемент--модификатор" — например, 
  `.user-info__title`, `.user-info__avatar__status-bullet`, `.user-info__avatar__status-bullet--active`.
